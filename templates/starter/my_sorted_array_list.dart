...
class MySortedArrayList {
  ...
  bool insert(int value) {
    ...
    // shift cells right, insert one occurrence and increase memory.size.
    return false;
  }
  ...
  bool remove(int value) {
    ...
    // to the left, clear the vacated cell and decrease memory.size.
    return false;
  }
...
ListMemory is observable indexed storage with nullable cells, capacity
memory.length and student-controlled logical length memory.size.
All occupied cells are the contiguous prefix 0..memory.size-1; remaining
