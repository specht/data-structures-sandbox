...
vm.runInContext("validationMessage({type:'validationResult',index:1,name:'Capacity',passed:false,message:'push(9): false',completed:2,total:2,passedCount:1})",context);
