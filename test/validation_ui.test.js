...
assert.equal(failureHistory.children[1].children[0].children[0].textContent,'push(1)');
assert.match(failureHistory.children[1].children[1].children[1].textContent,/Returned false.*expected true/);
assert.match(failureHistory.children[1].children[1].children[2].textContent,/Contents \[1\].*expected \[1,9\]/);
assert.match(failureHistory.children[1].children[1].children[3].children[0].textContent,/Return value: expected true, actual false/);
